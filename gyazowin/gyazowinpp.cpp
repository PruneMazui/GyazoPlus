...
// マクロ定義
#define UPLOAD_LOG_LINE_SIZE	(128)				// ログの書き込みサイズ（本来89byteで十分だがバッファとして確保）
#define	APPLICATION_NAME		"gyazowinpp"		// アプリケーション名
#define INIFILE_NAME			"gyazowinpp.ini"	// iniファイル名
#define INIFILE_SECTION_NAME	APPLICATION_NAME	// iniファイルセクション名

// グローバル変数:
HINSTANCE hInst;									// 現在のインターフェイス
TCHAR *szTitle			= _T(APPLICATION_NAME);		// タイトル バーのテキスト
